...
rrdtool fetch ping.rrd AVERAGE -s -100d | awk '/:/ {cmd="rrdtool update ping.rrd " $1 q; print cmd; s=.25*q;v=v+1; u=v/100; t=v%8; r=rand();q=3+s+v+2*u+3*(t-4)*(t-4)+10*r;if(v>70 && v< 80)q=0; system(cmd);}'
