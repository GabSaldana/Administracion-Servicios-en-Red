...
rrdtool fetch hdd.rrd AVERAGE -s -100d | awk '/:/ {cmd="rrdtool update hdd.rrd " $1 q; print cmd; s=.25*q;v=v+1; u=v/100; t=v%8; r=rand();q=3+s+v+2*u+3*(t-4)*(t-4)+10*r; system(cmd);}'
...
LINE2:shddcaledobs#039be5:"Average bits out" \
...
#rrdtool graph test.gif --start now-100d --end=now DEF:test=test.rrd:hdd:AVERAGE LINE2:test#FF0000:test 
