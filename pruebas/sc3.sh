#!/bin/sh
#rrdtool create sc3.rrd -b now-100d -s 86400 \
...
rrdtool fetch sc3.rrd AVERAGE -s -100d | awk '/:/ {cmd="rrdtool update sc3.rrd " $1 q; print cmd; s=.25*q;v=v+1; u=v/100; t=v%8; r=rand();q=3+s+v+2*u+3*(t-4)*(t-4)+10*r; system(cmd);}'

rrdtool graph sc3.png --start now-100d --end=now DEF:sc3=sc3.rrd:msgs:AVERAGE LINE2:sc3#FF0000:sc3 
